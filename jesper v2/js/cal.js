...
function selectPanelType(panelType) {
  let essentailText_1_a = "Esensielle";
  let essentailText_1_b = "415W";
  let essentailText_2_a = "En lønnsom investering";
  let essentailText_2_b = "214W/m2";
  let essentailText_3 = "Vår mest kostnadseffektive pakke for best mulig lønnsomhet. Høyeffektive solcellepaneler som passer til alle typer tak.";

  let designText_1_a = "Design";
  let designText_1_b = "405W";
  let designText_2_a = "Stilige paneler";
  let designText_2_b = "208W/m2";
  let designText_3 =
    "Denne pakken er perfekt for de som bryr seg litt ekstra om utseendet på solcellepanelene og ønsker å sikre et pent estetisk tak.";

  let proText_1_a = "Pro";
  let proText_1_b = "415W";
  let proText_2_a = "Solceller uten kompromisser";
  let proText_2_b = "234W/m2";
  let proText_3 =
    "Pro er et elegant og pålitelig panel med høy effektivitet. Panelet er produsert med innovativ teknologi og bærekraft i fokus. Med Pro får du en produktgaranti som sikrer høy effekt i lang tid.";
